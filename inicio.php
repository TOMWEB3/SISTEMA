    ...
    <div class="container">
      ...
      <div class="masthead">
        <ul class="nav nav-justified">
          <li class="active" id="inicioMenu"><a>Início</a></li>
      ...
      <div class="jumbotron" id="inicioConteudo">
        ...
        <p><a class="btn btn-lg btn-default" href="quadros.php" role="button">Iniciar Triagem</a></p>
      </div>
